...
public enum Pokemon {
    ...
    GOLEM(76, "golem", -14, -8, 24, PokemonType.ROCK, PokemonType.GROUND),
    RAPIDASH(78, "rapidash", -13, -6, 26, PokemonType.FIRE),
    ...
    KINGLER(99, "kingler", -16, -7, 25, PokemonType.WATER),
    ...
    DRAGONAIR(148, "dragonair", -16, -3, 28, PokemonType.DRAGON),
    ...
    MAREEP(179, "mareep", -14, -10, 22, PokemonType.ELECTRIC),
    ...
    HOUNDOOM(229, "houndoom", -14, -7, 24, PokemonType.DARK, PokemonType.FIRE),
    ...
    MIGHTYENA(262, "mightyena", -14, -8, 23, PokemonType.DARK),
    LUDICOLO(272, "ludicolo", -16, -4, 28, PokemonType.WATER, PokemonType.GRASS),
    ELECTRIKE(309, "electrike", -14, -14, 17, PokemonType.ELECTRIC),
    WAILMER(320, "wailmer", -16, -8, 22, PokemonType.WATER),
    WAILORD(321, "wailord", -32, -17, 24, PokemonType.WATER),
    TROPIUS(357, "tropius", -14, -5, 27, PokemonType.GRASS, PokemonType.FLYING),
    ABSOL(359, "absol", -16, -6, 26, PokemonType.DARK),
    ...
    BIDOOF(399, "bidoof", -12, -14, 17, PokemonType.NORMAL),
    SHINX(403, "shinx", -14, -13, 19, PokemonType.ELECTRIC),
    LUXRAY(405, "luxray", -14, -7, 25, PokemonType.ELECTRIC),
    LEAFEON(470, "leafeon", -19, -10, 22, PokemonType.GRASS),
    GLACEON(471, "glaceon", -16, -9, 22, PokemonType.ICE),
    GLISCOR(472, "gliscor", -14, -4, 26, PokemonType.GROUND, PokemonType.FLYING),
